...
if __name__ == "__main__":
    ...
    #     "file_" : "/eos/user/g/gboldrin/www/New/SSWW_OSWW_WZ_ZZ_ZV_noQuad/results.txt",
    #     "models" : ["EFTNeg"],
    #     "Color" : ROOT.kGray+1,
    ...
    #     "file_" : "/eos/user/g/gboldrin/www/New/SSWW_OSWW_WZ_ZZ_ZV/results.txt",
    #     "models" : ["EFTNeg"],
    #     "Color" : ROOT.kBlack,
    # }
    plotting["Combined"] = {
    ...
    A4 = ROOT.TGaxis(0,my, abs(mx) , my,"f4")
    ...
    for i,op in enumerate(first.keys()):
        ...
        for process in first[op]:
            ...
            tex_1s = ROOT.TLatex(max_x + 0.8*max_x, first[op][process]['gy'] ,"[{:.2f}({:.2f}),{:.2f}({:.2f})]".format(first[op][process]['1s'][0], first_nq[op][process]['1s'][0], first[op][process]['1s'][1], first_nq[op][process]['1s'][1]))
            tex_1s.SetTextFont(42)
            tex_1s.SetTextSize(0.016)
            tex_1s.SetLineWidth(2)

            tex_2s = ROOT.TLatex(max_x + 1.75*max_x, first[op][process]['gy'] ,"[{:.2f}({:.2f}),{:.2f}({:.2f})]".format(first[op][process]['2s'][0], first_nq[op][process]['2s'][0], first[op][process]['2s'][1], first_nq[op][process]['2s'][1]))
            tex_2s.SetTextFont(42)
            tex_2s.SetTextSize(0.016)
        ...
        my = np.mean(ys)
        tex = ROOT.TLatex(max_x + 0.4*max_x, my,"{}".format(ConvertOptoLatex(op)))
        tex.SetTextFont(52)
    ...
    A6 = ROOT.TGaxis(0,my, abs(mx) , my,"f6")
    ...
    for op in second.keys():
        ...
        for process in second[op]:
            ...
            if op == "cHl1" and process == "SSWW":
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, second[op][process]['gy'] ,"[{:.2f}({}),{:.2f}({})]".format(second[op][process]['1s'][0], ">100", second[op][process]['1s'][1], ">100"))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
               ...
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, second[op][process]['gy'] ,"[{:.2f}({:.2f}),{:.2f}({:.2f})]".format(second[op][process]['1s'][0], second_nq[op][process]['1s'][0], second[op][process]['1s'][1], second_nq[op][process]['1s'][1]))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
            
               tex_2s = ROOT.TLatex(max_x + 1.75*max_x, second[op][process]['gy'] ,"[-18, -17],[{:.2f}({:.2f}),{:.2f}({:.2f})]".format(second[op][process]['2s'][0], second_nq[op][process]['2s'][0], second[op][process]['2s'][1], second_nq[op][process]['2s'][1]))
               tex_2s.SetTextFont(42)
               tex_2s.SetTextSize(0.0215)
               tex_2s.SetLineWidth(2)
    ...
    A8 = ROOT.TGaxis(0,my, abs(mx) , my,"f8")
    ...
    for op in third.keys():
        ...
        for process in third[op]:
            ...
            if op == "cHbox" and process == "ZZ":
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, third[op][process]['gy'] ,"[{:.2f}({}),{:.2f}({})]".format(third[op][process]['1s'][0], ">100", third[op][process]['1s'][1], ">100"))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
               ...
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, third[op][process]['gy'] ,"[{:.1f}({}),{:.1f}({})]".format(third[op][process]['1s'][0], ">100", third[op][process]['1s'][1], ">100"))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
               ...
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, third[op][process]['gy'] ,"[{}({}),{}({})]".format(">100", ">100", ">100", ">100"))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
               ...
               tex_1s = ROOT.TLatex(max_x + 0.8*max_x, third[op][process]['gy'] ,"[{:.2f}({:.2f}),{:.2f}({:.2f})]".format(third[op][process]['1s'][0], third_nq[op][process]['1s'][0], third[op][process]['1s'][1], third_nq[op][process]['1s'][1]))
               tex_1s.SetTextFont(42)
               tex_1s.SetTextSize(0.0215)
               tex_1s.SetLineWidth(2)
    ...
    tex5 = ROOT.TLatex(0.69,.887, "68% L+Q (L)")
    tex5.SetNDC()
