...
if __name__ == "__main__":
    ...
    # }
    plotting_nq["WW"] = {
        "file_" : "/afs/cern.ch/work/g/gboldrin/public/public/CMSSW_10_2_13/src/HiggsAnalysis/AnalyticAnomalousCoupling/newWW_noQuad/sensPlots_inWW_noQuad/results.txt",
        "models" : ["EFTNeg"],
    ...
    plotting["WW"] = {
        ...
        "file_" : "/afs/cern.ch/work/g/gboldrin/public/public/CMSSW_10_2_13/src/HiggsAnalysis/AnalyticAnomalousCoupling/newWW/sensPlots_inWW/results.txt",
        "models" : ["EFTNeg"],
        "Color" : ROOT.kGreen+2,
    }   
    # plotting["Combined"] = {
    ...
    # }
    plotting["Combined"] = {
        #"file_" : "/eos/user/g/gboldrin/www/New/SSWW_OSWW_OSWWQCD_inWW_WZeu_WZQCD_ZZ/results_complete.txt",
        "file_" : "/afs/cern.ch/work/g/gboldrin/public/public/CMSSW_10_2_13/src/HiggsAnalysis/AnalyticAnomalousCoupling/newWW/sensPlots_SSWW_OSWW_OSWWQCD_inWW_WZeu_WZQCD_ZZ/results_complete.txt",
        "models" : ["EFTNeg"],
        "Color" : ROOT.kBlack,
    }
    ...
    pad2 = ROOT.TPad("pad1", "20",0.0, 0.3,1.0, 0.595)
    ...
    for op in second.keys():
        ...
        for process in second[op]:
            ...
            if op == "cHl1" and process == "OSWW":
                ...
                #g2_f.SetPointError(0, g2_f.GetErrorXlow(0)*per, g2_f.GetErrorXhigh(0)*per, g2_f.GetErrorYlow(0), g2_f.GetErrorYhigh(0))
                #g1_f.SetPointError(0, g1_f.GetErrorXlow(0)*per, g1_f.GetErrorXhigh(0)*per, g1_f.GetErrorYlow(0), g1_f.GetErrorYhigh(0))
                g2_f.SetPointError(0, 5, 5, g2_f.GetErrorYlow(0), g2_f.GetErrorYhigh(0))
                g1_f.SetPointError(0, 5, 5, g1_f.GetErrorYlow(0), g1_f.GetErrorYhigh(0))
            if op == "cHl1" and process == "SSWW":
                name += " #times 0.1"
                per = 0.1
                g2.SetPointError(0, g2.GetErrorXlow(0)*per, g2.GetErrorXhigh(0)*per, g2.GetErrorYlow(0), g2.GetErrorYhigh(0))
    ...
    # tex = ROOT.TLatex(0.13,.992,"Simulation")
    # tex.SetNDC()
    # tex.SetTextFont(52)
    ...
    tex3 = ROOT.TLatex(0.87,.97,"#Lambda=1 TeV   100 fb^{-1}   (13 TeV)")
    tex3.SetNDC()
    ...
    tex4 = ROOT.TLatex(0.479,.005, "Parameter Estimate [TeV^{-2}]")
    tex4.SetNDC()
    ...
    tex5 = ROOT.TLatex(0.725,.887, "68% L+Q (L)")
    tex5.SetNDC()
    ...
    tex6 = ROOT.TLatex(0.857,.887, "95% L+Q (L)")
    tex6.SetNDC()
